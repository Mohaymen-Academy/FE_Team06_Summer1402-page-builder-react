...
function Page(props) {
    ...
    return (
        <Layout>
            <div className="bg-[#D7D8DD] justify-center p-10  flex flex-row overflow-y-scroll fixed top-[100px] left-[300px] right-[200px] h-screen smmobile:left-0 smmobile:right-0 smmobile:top-[200px] vsmmobile:left-0 vsmmobile:right-0 vsmmobile:top-[200px]">
