...
function Page(props) {
    ...
    return (
        <Layout>
            <div className="bg-[#D7D8DD] pt-2 justify-center flex flex-row overflow-y-scroll h-[45rem] fixed left-[300px] right-[200px] smmobile:left-0 smmobile:right-0 smmobile:relative vsmmobile:left-0 vsmmobile:right-0 vsmmobile:relative">
