...
export default function Video() {
  ...
  const [autoplay, setautoplay] = useState(getValue(layoutContext,'autoplay'));
  // handle drag events
  function handleSetting(func, value) {
    layoutContext.current.setters[func](value);
  }
  function changeAutoplay() {
    handleSetting('setautoplay', !autoplay);
      ...
      <div>
        ...
        <div className="flex flex-row justify-between py-[7px]  ">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            <input type="checkbox" checked={autoplay ? true : false} className="sr-only peer" onChange={changeAutoplay} />
