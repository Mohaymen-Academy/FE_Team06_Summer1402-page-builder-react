        ...
        <div
            ...
            }}>
            {
                states.image.map((src, index) => {
                    return <Card key={index} borderRadius={states.radius} bgcolor={states.bgColor}  imgsrc={src} type={states.type} text={states.text} link={states.link} width={states.width} size={states.size} padding={states.padding} margin={states.gap} />
                })
            }
        </div>
    )
