...
export default function YellowBox({ remove, children }) {
  return (
    <div
      ...
      <div className=" flex flex-col  justify-start items-start  h-fit vsmmobile:mb-0">
        <div className=" flex flex-row border-solid border-2 border-[#FFD1A1] border-b-0 rounded-full rounded-br-none items-center justify-around ">
          ...
          <img className="w-[15px] h-[15px] vsmmobile:w-[10px] vsmmobile:h-[10px]" src="images/yellow trash.png" onClick={remove} onTouchStart={remove} />
